...
gulp.task('js-lib', function() {
    return gulp.src('ui/javascripts/lib/**/*.js')
...
gulp.task('css', function() {
    return gulp
            .src('ui/stylesheets/style.scss')
            .pipe(
                sass({
                    includePaths: ['ui/stylesheets'],
...
gulp.task('fonts', function() {
    return gulp
            .src('ui/fonts/**/*.{otf,svg,ttf,woff,eot}')
...
gulp.task('jade', function() {
    ...
    delete require.cache[require.resolve('./ui/javascripts/utils')];
    var utils = require('./ui/javascripts/utils');
    ...
    return gulp.src('ui/templates/index.jade')
               .pipe(jade({
